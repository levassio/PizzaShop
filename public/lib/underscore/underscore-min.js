...
(function () {
    ...
    h.reduce = h.foldl = h.inject = function (n, t, r, e) {
        ...
        for (var t, r = n && n.length === +n.length
            ? n
            : h.values(n), e = r.length, u = Array(e), i = 0; e > i; i++) {
    ...
    h.bind = function (n, t) {
        ...
        return function () {
            ...
            o || r.leading !== !1 || (o = c);
            var f = t - (c - o);
            return e = this, u = arguments, 0 >= f || f > t
                ? (clearTimeout(a), a = null, o = c, i = n.apply(e, u), a || (e = u = null))
                : a || r.trailing === !1 || (a = setTimeout(l, f)), i
        }
    ...
    var _ = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#x27;", "`": "&#x60;"}, w = h.invert(_), j = function (n) {
        var t = function (t) {
            return n[t]
    ...
    h.template = function (n, t, r) {
        ...
        n.replace(e, function (t, r, e, a, o) {
            return i += n.slice(u, o).replace(O, F), u = o + t.length, r
